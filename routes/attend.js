...
const { getAcceptList, getMyAcceptList, joinPost, cancelJoin } = require('../controllers/attend');

router.get('/:postId/acceptlist', verifyToken, getAcceptList);
router.get('/:postId/acceptlist/:userId', verifyToken, getMyAcceptList);
router.post('/:postId/acceptlist', verifyToken, joinPost);
router.delete('/:postId/acceptlist/:id', verifyToken, cancelJoin);
